...
class AutoTwistCompensator
{
    public:
        AutoTwistCompensator(ros::NodeHandle &n): node_(n) {
            ...
            ros::Subscriber cmd_sub = node_.subscribe("cmd_vel",1,&AutoTwistCompensator::twist_callback, this);
            ros::Subscriber imu_sub = node_.subscribe("imu/data",1,&AutoTwistCompensator::imu_callback, this);
...
{
    ros::init(argc,argv, "husky_yaw_compensator");
    ros::NodeHandle nh;
